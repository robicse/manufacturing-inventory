...
@section('content')
    <main class="app-content">
        <div class="app-title">
            <div>
                <h1><i class=""></i> Add Product Unit</h1>
            </div>
        ...
        <div class="col-md-12">
            <div class="tile">
                <h3 class="tile-title">Add Product Unit</h3>
                <div class="tile-body tile-footer">
                    ...
                    <form method="post" action="{{ route('productUnits.store') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <button class="btn btn-primary" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>Save Product Unit</button>
                            </div>
                        </div>
                    </form>
                </div>
