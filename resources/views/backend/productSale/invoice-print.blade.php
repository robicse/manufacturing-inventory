                                    ...
                                    <div class="page" style="">
                                                    ...
                                                    <table>
                                                        ...
                                                        <tr>
                                                            <td
                                                                style="text-align: left;font-size: 16px;border-right: 1px solid #000000">
                                                                BIN Reg. NO:</td>
                                                            <td style="text-align: left;font-size: 16px;">001719214-0201
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td
                                                                style="text-align: left;font-size: 16px;border-right: 1px solid #000000">
                                                                Phone No.</td>
                                                            <td style="text-align: left;font-size: 16px;">02-223362755
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($productSaleDetails as $key => $productSaleDetail)
                                                    <tr>
                                                        ...
                                                        <td style="text-align: left">
                                                            {{ $productSaleDetail->product->name }}</td>
                                                        <td>{{ $productSaleDetail->qty }}</td>
                                                        <td>{{ $productSaleDetail->product_unit->name }}</td>
                                                        <td style="text-align: right">
                                                            {{ number_format($productSaleDetail->price, 2) }}</td>
                                                        <td style="text-align: right">
                                                            @php
                                                ...
                                                <tr>
                                                    ...
                                                    <th style="text-align: right">
                                                        {{ number_format($sum_sub_total, 2) }}</th>
                                                </tr>
                                                <tr>
                                                    <th colspan="4">&nbsp;</th>
                                                ...
                                                <tr>
                                                    ...
                                                    <th style="text-align: right">
                                                        {{ number_format($productSale->total_amount, 2) }}</th>
                                                </tr>
                                                <tr>
                                                    <th colspan="4">&nbsp;</th>
                                                    <th style="text-align: right">Paid Amount:</th>
                                                    <th style="text-align: right">
                                                        {{ number_format($productSale->paid_amount, 2) }}</th>
                                                </tr>
                                                <tr>
                                                    <th colspan="4">&nbsp;</th>
                                                    <th style="text-align: right">Due Amount:</th>
                                                    <th style="text-align: right">
                                                        {{ number_format($productSale->due_amount, 2) }}</th>
                                                </tr>
                                                <tr>
                                                    <th colspan="4">&nbsp;</th>
                                                    <th style="text-align: right">Previous Due Amount:</th>
                                                    <th style="text-align: right">{{ number_format($previous_due, 2) }}
                                                    </th>
                                                </tr>
                                            </tbody>
                                        </table>
                                        <div class="write">
                                            <p class="lead"><b>In Word :
                                                    {{ ucwords($digit->format($productSale->total_amount)) }} Only.</b>
                                            </p>
                                        </div>
                                        <div class="row" style="">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <p style="text-align: left;font-size: 16px;" class="lead">Payment
                                                    Type:</p>
